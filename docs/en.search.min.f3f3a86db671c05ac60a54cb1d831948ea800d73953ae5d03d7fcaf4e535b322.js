...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/abl/flexsearch.min.js');loadScript('/abl/en.search-data.min.68ae918d2f4de23704162293d17b8bc2dc8c0229fb7fb580c82deffa03e817cf.js',function(){input.required=false;search();});}
