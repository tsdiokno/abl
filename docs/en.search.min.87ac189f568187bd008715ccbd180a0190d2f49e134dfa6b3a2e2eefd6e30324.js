...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/abl/flexsearch.min.js');loadScript('/abl/en.search-data.min.032ee121a5fbb89399d5b8cc603accd1f7ef88a96c81b7496caab5bdc05c1857.js',function(){input.required=false;search();});}
