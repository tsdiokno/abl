...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/abl/flexsearch.min.js');loadScript('/abl/en.search-data.min.a3820e1afb5bbfb96a60def52b8e4418df88c0978b69a6e36baf7e767e733a35.js',function(){input.required=false;search();});}
