...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/abl/flexsearch.min.js');loadScript('/abl/en.search-data.min.f03cf6ebc5b918fa2fd1bd1ab59d9efe79f9482e88df560d9aba9f37dab3797c.js',function(){input.required=false;search();});}
