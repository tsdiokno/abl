...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/abl/flexsearch.min.js');loadScript('/abl/en.search-data.min.1cc89640e0862cc33aca8e385fdfb218d794bd0946fbe7409e6bf66fa07d0db6.js',function(){input.required=false;search();});}
