...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/abl/flexsearch.min.js');loadScript('/abl/en.search-data.min.45e7a374904526cd820660762f693666a3ec507f97c60de34cb01d56dd30ee2d.js',function(){input.required=false;search();});}
